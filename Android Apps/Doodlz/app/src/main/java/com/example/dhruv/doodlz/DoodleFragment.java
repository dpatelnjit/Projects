package com.example.dhruv.doodlz;
...
{
   private com.example.dhruv.doodlz.DoodleView doodleView; // handles touch events and draws
      ...
      Bundle savedInstanceState)
   {
      ...
      doodleView = (com.example.dhruv.doodlz.DoodleView) view.findViewById(R.id.doodleView);
   ...
   {
      com.example.dhruv.doodlz.EraseImageDialogFragment fragment = new com.example.dhruv.doodlz.EraseImageDialogFragment();
   ...
   public boolean onOptionsItemSelected(MenuItem item) 
   {
      ...
      {
         case R.id.color:
            com.example.dhruv.doodlz.ColorDialogFragment colorDialog = new com.example.dhruv.doodlz.ColorDialogFragment();
            colorDialog.show(getFragmentManager(), "color dialog");
            return true; // consume the menu event
         case R.id.lineWidth:
            com.example.dhruv.doodlz.LineWidthDialogFragment widthdialog =
               new com.example.dhruv.doodlz.LineWidthDialogFragment();
   ...
   public com.example.dhruv.doodlz.DoodleView getDoodleView()
   {
      return doodleView;
   }
